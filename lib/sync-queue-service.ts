...
import { sincronizarCabecalhoNotaPorEmpresa } from './sync-cabecalho-nota-service';
import { sincronizarFinanceiroPorEmpresa } from './sync-financeiro-service';
...
class SyncQueueService {
  ...
  private tabelas: TabelaSincronizacao[] = [
    ...
    {
      nome: 'Cabeçalho de Nota',
      rota: '/api/sync/cabecalho-nota',
      maxTentativas: 3,
      funcaoSync: sincronizarCabecalhoNotaPorEmpresa
    },
    {
      nome: 'Financeiro',
      rota: '/api/sync/financeiro',
      maxTentativas: 3,
      funcaoSync: sincronizarFinanceiroPorEmpresa
    },
    {
      nome: 'Vendedores',
