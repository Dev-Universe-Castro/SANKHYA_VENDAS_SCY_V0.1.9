...
import { sincronizarTabelaPrecosPorEmpresa, sincronizarTodasEmpresas, obterEstatisticasSincronizacao } from '@/lib/sync-tabela-precos-service';
...
export async function POST(request: Request) {
  try {
    ...
    if (idSistema && empresa) {
      ...
      const resultado = await sincronizarTabelaPrecosPorEmpresa(parseInt(idSistema), empresa);
